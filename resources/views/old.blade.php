    {{-- <div
        ...
        @if (Route::has('login'))
            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10 w-96">
                @auth('admin')
                    ...
                    <a href="{{ url('/admin/dashboard') }}"
                        ...
                        Dashboard</a>
                    @elseauth('web')
                    <!-- Regular user is logged in, show user dashboard link -->
                ...
                @else
                    <a href="{{ route('login') }}"
                        class="font-semibold mx-3 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                        Log As User
                    </a>
                    ...
                    <a href="{{ route('admin.login') }}"
                        class=" ml-4 font-semibold admin dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                        Admin
                    </a>
                @endauth
            </div>
            ...
            <div class="relative overflow-hidden bg-white">
                ...
                <section aria-labelledby="sale-heading"
                    ...
                    <div class="mx-auto max-w-2xl lg:max-w-none">
                        ...
                        <p class="mx-auto mt-4 max-w-xl text-xl text-gray-600">Most of our products are limited releases
                            that won't come back. Get your favorite items while they're in stock.</p>
                        <a href="#"
                            class="mt-6 inline-block w-full rounded-md border border-transparent bg-gray-900 px-8 py-3 font-medium text-white hover:bg-cyan-800 sm:w-auto">Get
                        ...
                        <div class="mt-16 space-y-16 lg:grid lg:grid-cols-3 lg:gap-x-8 lg:space-y-0">
                            <blockquote class="sm:flex lg:block">
                                ...
                                <div class="mt-8 sm:ml-6 sm:mt-0 lg:ml-0 lg:mt-10">
                                    ...
                                    <cite class="mt-4 block font-semibold not-italic text-gray-900">Shehab ,
                                        England</cite>
                                </div>
                            </blockquote>
                            <blockquote class="sm:flex lg:block">
                                ...
                                <div class="mt-8 sm:ml-6 sm:mt-0 lg:ml-0 lg:mt-10">
                                    ...
                                    <cite class="mt-4 block font-semibold not-italic text-gray-900">Najib,
                                        malaysia</cite>
                                </div>
                            </blockquote>
                            <blockquote class="sm:flex lg:block">
                                ...
                                <div class="mt-8 sm:ml-6 sm:mt-0 lg:ml-0 lg:mt-10">
                                    ...
                                    <cite class="mt-4 block font-semibold not-italic text-gray-900">Yousef, New
                                        York</cite>
                                </div>
                            </blockquote>
                        </div>
